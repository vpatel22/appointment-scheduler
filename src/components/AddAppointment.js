...
const AddAppointment = ({ lastId, onSendAppointment }) => {
  ...
  return (
    <div>
      <button onClick={() => { setToggleForm(!toggleForm); }} type="button" className={`bg-blue-400 text-white px-2 py-3 w-full text-left ${toggleForm ? 'rounded-t-md' : 'rounded-md'}`}>
        <div>
          ...
          <div className="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start  sm:pt-5">
            ...
            <div className="mt-1 sm:mt-0 sm:col-span-2">
              <input
                type="text"
                onChange={
                    (event) => { setFormData({ ...formData, ownerName: event.target.value }); }
                }
          ...
          <div className="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start  sm:pt-5">
            ...
            <div className="mt-1 sm:mt-0 sm:col-span-2">
              <input
                type="text"
                onChange={
                    (event) => { setFormData({ ...formData, petName: event.target.value }); }
                }
          ...
          <div className="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start  sm:pt-5">
            ...
            <div className="mt-1 sm:mt-0 sm:col-span-2">
              <input
                type="date"
                onChange={
                    (event) => { setFormData({ ...formData, aptDate: event.target.value }); }
                }
          ...
          <div className="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start  sm:pt-5">
            ...
            <div className="mt-1 sm:mt-0 sm:col-span-2">
              <input
                type="time"
                onChange={
                    (event) => { setFormData({ ...formData, aptTime: event.target.value }); }
                }
          ...
          <div className="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start  sm:pt-5">
            ...
            <div className="mt-1 sm:mt-0 sm:col-span-2">
              <textarea
                id="aptNotes"
                onChange={
                    (event) => { setFormData({ ...formData, aptNotes: event.target.value }); }
                }
